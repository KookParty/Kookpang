<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
  <%@taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
    ...
    <body>
      ...
      <main class="container page" id="root"></main>
      <script>
        requireAuth(); const id = +q('id'); const orders = S.get(KP_KEYS.ORDERS, []); const o = orders.find(x => x.id === id) || orders[orders.length - 1];
