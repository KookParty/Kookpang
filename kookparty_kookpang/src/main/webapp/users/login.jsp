    ...
    <body>
      ...
      <main class="container page">
        <section class="card" style="max-width:520px;margin:80px auto;padding:24px">
          ...
          <div class="form-row"><input id="pass" type="password" class="input" placeholder="비밀번호를 입력해주세요"></div>
          <button id="doLogin" class="btn dark full">로그인</button>
          <p class="small" style="text-align:center;margin:12px 0 0">회원이 아니세요? <a
              href="${path}/users/register.jsp">회원가입하러 가기</a></p>
        </section>
      </main>
      <!-- footer 시작 -->
