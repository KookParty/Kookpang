                        ...
                        <div class="card mb-4">
                            <div class="card-header row">
                                ...
                                <div class="col-md-6 text-end">
                                    <button type="button" class="btn btn-danger btn-sm" id="deleteBtn">선택 삭제</button>
                                </div>
                            </div>
                            <div class="card-body">
                                <form action="${path}/front?key=admin&methodName=deleteProducts" method="post" id="deleteForm">
