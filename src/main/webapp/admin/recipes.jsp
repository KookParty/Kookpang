          ...
          <main>
            <div class="container-fluid px-4">
              ...
              <div class="card mb-4">
                ...
                <div class="card-body">
                  <form action="${path}/front?key=admin&methodName=deleteRecipes" method="post" id="deleteForm">
                    <table id="datatablesSimple">
                      ...
                      <tbody>
                        <c:forEach var="item" items="${list}">
                          <tr>
                            <td><input type="checkbox" name="selectedItems" value="${item.recipeId}"></td>
                            <td>${item.title}</td>
