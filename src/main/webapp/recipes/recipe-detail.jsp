    ...
    <div class="wrap">
      ...
      <div class="hero">
        ...
        <div style="flex: 1">
          ...
          <div class="meta">
            <span>${recipe.category}</span><span>${recipe.way}</span><span>❤️</span
            ><span id="likeCnt">${recipe.likeCnt}</span>
          </div>
          ...
          <c:choose>
            ...
            <c:otherwise>
              <c:forEach items="${recipe.ingredients}" var="ingredientDTO">
                <div
                  class="row"
                  data-id="${ingredientDTO.ingredientId}"
                  data-title="${ingredientDTO.name} (${ingredientDTO.quantity})"
                  data-price="${ingredientDTO.price}"
                >
                  <c:choose>
                ...
                <div class="card variant">
                  ...
                  <div style="flex: 1">
                    ...
                    <div class="actions-row">
                      <a
                        class="ghost-link muted2"
                        href="${path}/front?key=recipe&methodName=recipeDetail&recipeId=${variant.recipeId}"
                      >
      ...
      <div id="panel-reviews" class="panel">
        ...
        <div id="reviewList" class="card" data-rid="${recipe.recipeId}"></div>
      </div>
    </div>
    <!-- footer 시작 -->
