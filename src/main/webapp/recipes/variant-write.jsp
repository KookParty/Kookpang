  ...
  <%@taglib uri="jakarta.tags.core" prefix="c" %>
    ...
    <body>
      ...
      <main class="container page" style="max-width: 980px; padding: 16px;">
        ...
        <form id="writeForm" name="writeForm" method="post" action="${path}/front" onsubmit="return submitForm()" enctype="multipart/form-data">
          ...
          <section class="card" style="padding:16px">
            ...
            <div class="form-row">
              <textarea name="desc" id="desc" class="input" rows="3" placeholder="레시피에 대한 설명을 입력해주세요"></textarea>
            </div>
          
            <label class="small">썸네일 이미지</label>
            <div class="row">
              <input type="file" name="thumb" id="thumb" class="input" placeholder="이미지 URL을 입력해주세요" style="flex:1">
            </div>
          
            <div class="row">
              <div style="flex:1">
                <label class="small">요리 종류</label>
                <input type="text" name="pattern" id="pattern" class="input" placeholder="요리 종류를 입력해주세요 (반찬/국&찌개/일품/후식)">
              </div>
              <div style="flex:1">
                <label class="small">조리 방법</label>
                <input type="text" name="way" id="way" class="input" placeholder="조리 방법을 입력해주세요 (굽기/찌기/끓이기/기타)">
              </div>
            </div>
          </section>
